...
def get_args():
    ...
    parser.add_argument("--do_dev", action="store_true", default=True)
...
if __name__ == '__main__':
    ...
    try:
        ...
        if args.do_train:
            ...
            with open(save_encoding_path + 'train_alignment_' + str(_lambda) + '.pkl', 'wb') as f:
        ...
        if args.do_dev:
            ...
            with open(save_encoding_path + 'dev_alignment_' + str(_lambda) + '.pkl', 'wb') as f:
        ...
        if args.do_test:
            ...
            with open(save_encoding_path + 'test_alignment_' + str(_lambda) + '.pkl', 'wb') as f:
