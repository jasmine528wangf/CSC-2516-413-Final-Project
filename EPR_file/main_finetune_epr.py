...
if __name__ == '__main__':
    ...
    if args.is_train:
        train_token_data, train_alignment_data = get_data(token_cache_path, alignment_cache_path, 'train', _lambda=args._lambda)
        train_dataloader = DataLoader(train_token_data, train_alignment_data, 'train')

        test_token_data, test_alignment_data = get_data(token_cache_path, alignment_cache_path, 'test',_lambda=args._lambda)
